<?php
	...
	$def = "./base/MDDB/defaults.mddb";
	$fileExistsC = file_exists($conf);
	$fileExistsD = file_exists($def);
	if(!$fileExistsC || !$fileExistsD){
				...
				<div class="cardStyle">
					<form method="post" name="login" id="login" action="access.php">
								...
								<div class="col-sm-6" style="border-left: 1px solid rgba(80,80,80,0.2);">
									<div class="row">
										<div class="col-xs-1 col-sm-2 col-md-2">
											<label for="user" class='top10'><span class="fa fa-user fa-lg"></span></label>
										</div>
									...
									<div class="row">
										<div class="col-xs-1 col-sm-2 col-md-2">
											<label for="password" class='top10'><span class="fa fa-lock fa-lg"></span></label>
										</div>
										<div class="col-xs-11 col-sm-10 col-md-10">
						...
						<div class="padding10" align="right" style="max-height:60px;">
							<input type="submit" class="btn btn-info" value="Acessar" id="Access" name="Access" />
						</div>
					</form>
				</div>
			</div>			
